  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="relative flex items-center gap-2.5 sm:gap-3 bg-emerald-600 hover:bg-emerald-500 text-white pl-3.5 pr-4 sm:pl-4 sm:pr-5 py-3 sm:py-3.5 rounded-full shadow-lift transition-colors"
      >
        <svg
          width="22"
          height="22"
